...
CREATE TABLE `courses` (
  ...
  `CourseMaxSize` int(11) DEFAULT NULL,
  `CourseDesc` longtext,
  `LectureID` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`CourseID`),
  KEY `LectureID` (`LectureID`),
  KEY `LecturesCourses` (`LectureID`),
  CONSTRAINT `LecturesCourses` FOREIGN KEY (`LectureID`) REFERENCES `lectures` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
