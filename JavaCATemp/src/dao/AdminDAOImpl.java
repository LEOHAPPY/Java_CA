...
public class AdminDAOImpl implements PersonDAO {
	...
	public Person findPerson(String id) throws DAOException {
		String selectSql = "SELECT * FROM Admins WHERE id='" + id.trim()
				+ "';";
		try {
			Class.forName("com.mysql.jdbc.Driver");
		} catch (ClassNotFoundException e1) {
	...
	public void insertPerson(Person p) throws DAOException {
		String insertSql = "INSERT INTO Admins VALUES('" + p.getId()
	...
	public void updatePerson(Person p) throws DAOException {
		String updateSql = "UPDATE Admins SET name = '"
