...
public class PersonDAOImpl implements PersonDAOAdmin {
	...
	public void deletePerson(Person p,String role) throws DAOException {
	...
	public Person findPerson(String id,String role) throws DAOException {
	...
	public void insertPerson(Person p,String role) throws DAOException {
		String insertSql = "INSERT INTO "+role+" VALUES('" + p.getId()
	...
	public void updatePerson(Person p,String role) throws DAOException {
		String updateSql = "UPDATE "+role+" SET name = '"
